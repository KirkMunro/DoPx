...
<#
.SYNOPSIS
    Removes a snapshot from your DigitalOcean environment.
.DESCRIPTION
    The Remove-DoPxImage command removes a snapshot from your DigitalOcean environment.
.INPUTS
...
.EXAMPLE
    ...
    PS C:\> Remove-DoPxSnapshot -Id 7606405

    This command removes the snapshot with id 7606405 from your DigitalOcean environment.
.EXAMPLE
    PS C:\> $accessToken = ConvertTo-SecureString -String a91a22c7d3c572306e9d6ebfce5f1f697bd7fe8d910d9497ca0f75de2bb37a32 -AsPlainText -Force
    PS C:\> Set-DoPxDefaultAccessToken -AccessToken $accessToken
    PS C:\> Get-DoPxSnapshot | Remove-DoPxSnapshot

    This command removes all snapshots from your DigitalOcean environment.
.LINK
    Copy-DoPxSnapshot
.LINK
    Get-DoPxSnapshot
...
Export-ModuleMember -Function Remove-DoPxSnapshot
# SIG # Begin signature block
# MIIZIAYJKoZIhvcNAQcCoIIZETCCGQ0CAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUwjz4pXVaoKXDS+wrQB0NIbkZ
# ZbmgghRWMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFJYh
# VGjyI+dkFJTHF1aOSb8M/EyCMA0GCSqGSIb3DQEBAQUABIIBAIc8h8oOne6EREIt
# sKMn69cP809kQ1mfEaiaTBUShCtBsuFSg8EkfBwYvW6jAJFQGRMpo0YkAj+S9wtH
# qyr9wtbcJQu+BDf0uqGB8ZUCMJEb0D18w09ro+Arx5Q8PDLQKQPXGjSC2i/FFjO8
# QkCvQw9QobhDex+RfkVYRfP1ommYmHBWG2nc+RzmJh7OppluYtKg3Rkh1nhFFuUh
# b3el6GlhtatLC/KF1KDPTB8TWEqIXBvmoZbMDEWip8u0342g/G8eDH/upMQsUC7+
# VJNGOjMGVJO5hwGAeegqE53JLrYB3FdLuPp5j6cmli3mF6BhRLeV4iqJyQ7mB9wZ
# 3OCs8OKhggILMIICBwYJKoZIhvcNAQkGMYIB+DCCAfQCAQEwcjBeMQswCQYDVQQG
# EwJVUzEdMBsGA1UEChMUU3ltYW50ZWMgQ29ycG9yYXRpb24xMDAuBgNVBAMTJ1N5
# bWFudGVjIFRpbWUgU3RhbXBpbmcgU2VydmljZXMgQ0EgLSBHMgIQDs/0OMj+vzVu
# BNhqmBsaUDAJBgUrDgMCGgUAoF0wGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAc
# BgkqhkiG9w0BCQUxDxcNMTQxMDA2MDI1MzA2WjAjBgkqhkiG9w0BCQQxFgQUD6q2
# uaqQOlz4yPf/PWBgL8u1nhUwDQYJKoZIhvcNAQEBBQAEggEAD+3/0oW1WP6VixTc
# UR4905b6EsXBMM1ZvLeQH/VphKn8kXzsvwGWk+CFbghpRJ7wXEih/aWOs1HFvyFD
# izA3DVH1TNe1AGIkJUjLWQUiXY4kLPgqg7+ScaHl20IhWxva0f1jszUwxhX4RZbZ
# jdVD2HiSE/CNByIjwWGGtJrvx8U/Ivf9Kv8x7swowplXU/mOZGOGVqecIwfQW3Kj
# gDDAK7Fwb0oxKPXxbPx53tlhgv6VzJJiKv/OGhCS0tnjkyixobfLmL2VrVk36XUk
# gg/yJJ3AEq2UWoilyQhLldPihARlVH/skRfhN6t03710VxKKL28goWQmLY5CFNGU
# hMJEDA==
